...
Supplier	Vendor master data. Used for segmentation and spend analysis.
Material	Product/raw-material master. SKU-level and category reporting.
Inventory	Current stock per warehouse. Track stock levels and days of inventory.
StockMovement	Receipts/issues/transfers. Analyze turnover and traceability.
Warehouse	Warehouse master (location, name). Slice inventory or throughput.
Shipment	Inbound/outbound shipments. Measure transit and carrier performance.
Carrier	Carrier master. Compare carrier performance.
...
SupplierPerformance	Precomputed KPIs. Benchmark supplier performance.
